...
<mark>## STEP 1B:
Get unbiased alignments with hla-mapper4:
...
Please note that hla-mapper can handle uncompressed and compressed FASTQ files.</mark>
```diff
...
<mark style="background-color:green"> We used IGV to inspect some of the hla-mapper BAM files generated by hla-mapper (Sample_Name.adjusted.bam) to ensure that everything was correct. </mark>
